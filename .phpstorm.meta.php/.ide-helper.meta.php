...
namespace PHPSTORM_META {
	...
	expectedArguments(
		\App\Model\Entity\AdminUser::get(),
		0,
		argumentsSet('entityFields:App\Model\Entity\AdminUser')
	);

	expectedArguments(
		\App\Model\Entity\AdminUser::getError(),
		0,
		argumentsSet('entityFields:App\Model\Entity\AdminUser')
	);

	expectedArguments(
		\App\Model\Entity\AdminUser::getInvalidField(),
		0,
		argumentsSet('entityFields:App\Model\Entity\AdminUser')
	);

	expectedArguments(
		\App\Model\Entity\AdminUser::getOriginal(),
		0,
		argumentsSet('entityFields:App\Model\Entity\AdminUser')
	);

	expectedArguments(
		\App\Model\Entity\AdminUser::has(),
		0,
		argumentsSet('entityFields:App\Model\Entity\AdminUser')
	);

	expectedArguments(
		\App\Model\Entity\AdminUser::hasValue(),
		0,
		argumentsSet('entityFields:App\Model\Entity\AdminUser')
	);

	expectedArguments(
		\App\Model\Entity\AdminUser::isDirty(),
		0,
		argumentsSet('entityFields:App\Model\Entity\AdminUser')
	);

	expectedArguments(
		\App\Model\Entity\AdminUser::isEmpty(),
		0,
		argumentsSet('entityFields:App\Model\Entity\AdminUser')
	);

	expectedArguments(
		\App\Model\Entity\AdminUser::setDirty(),
		0,
		argumentsSet('entityFields:App\Model\Entity\AdminUser')
	);

	expectedArguments(
		\App\Model\Entity\AdminUser::setError(),
		0,
		argumentsSet('entityFields:App\Model\Entity\AdminUser')
	);
	...
	override(
		...
		map([
			'Admin' => \Cake\Http\BaseApplication::class,
	...
	override(
		...
		map([
			'AdminUsers' => \App\Model\Table\AdminUsersTable::class,
	...
	override(
		...
		map([
			'AdminUsers' => \Cake\ORM\Association\BelongsToMany::class,
	...
	override(
		...
		map([
			'AdminUsers' => \Cake\ORM\Association\BelongsTo::class,
	...
	override(
		...
		map([
			'AdminUsers' => \Cake\ORM\Association\HasMany::class,
	...
	override(
		...
		map([
			'AdminUsers' => \Cake\ORM\Association\HasOne::class,
	...
	registerArgumentsSet(
		'entityFields:App\Model\Entity\AdminUser',
		'created',
		'id',
		'modified',
		'password',
	...
	registerArgumentsSet(
		...
		'Admin.AdminUsers::logout',
		'Admin.AdminUsers::unauthenticated',
		'Admin.Home::index',
