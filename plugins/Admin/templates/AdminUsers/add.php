<div class="bjui-pageContent bj-page-wrapper-content">
    <form
        action="<?php echo $this->Url->build(['plugin' => 'Admin', 'controller' => 'AdminUsers', 'action' => 'add'])?>"
    ...
    >
        ...
        <div class="bj-form-item">
            ...
            <div class="bj-form-item-content">
                <input type="text" name="username" value="" data-rule="required">
            </div>
        </div>
        ...
        <div class="bj-form-item">
            ...
            <div class="bj-form-item-content">
                <input type="text" name="state" value="" data-rule="required">
            </div>
        </div>
